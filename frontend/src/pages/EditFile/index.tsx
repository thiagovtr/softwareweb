          ...
          <div className="space-y-5 mb-8">
            <div className="relative">
              ...
              <input
                ...
                className="w-full border border-gray-200 bg-gray-50 rounded-xl py-4 pl-12 pr-4 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:bg-white transition-all"
                value={title}
            ...
            <div className="relative">
              ...
              <select
                className="w-full border border-gray-200 bg-gray-50 rounded-xl py-4 pl-12 pr-10 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:bg-white transition-all appearance-none cursor-pointer text-gray-700"
                value={subjectId}
            ...
            <div className="relative">
              ...
              <textarea
                ...
                rows={4}
                className="w-full border border-gray-200 bg-gray-50 rounded-xl py-4 pl-12 pr-4 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:bg-white transition-all resize-none"
                value={description}
          ...
          <button
            ...
            className={`w-full text-white p-4 rounded-xl font-bold flex justify-center items-center gap-2 transition-all duration-200 ${
              loading
                ...
                : "bg-yellow-500 cursor-pointer hover:bg-yellow-600 hover:-translate-y-1 hover:shadow-lg active:scale-95"
            }`}
          >
            {loading ? (
              <>
