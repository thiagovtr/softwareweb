        ...
        <div className="w-full px-6 sm:px-10 lg:px-16">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-blue-600 to-indigo-500 text-white flex items-center justify-center text-lg font-bold shadow-md border-2 border-white">
      ...
      >
        ...
        <div className="p-4 border-t border-gray-100">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 p-4 rounded-xl text-red-600 font-bold bg-red-50 hover:bg-red-100 active:scale-95 transition-all duration-200"
          >
            <svg
              className="w-5 h-5"
              fill="none"
