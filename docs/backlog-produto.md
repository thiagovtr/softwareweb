...
| FNF01 | Requisito Não Funcional | Restrição de Tamanho do Arquivo | Limite máximo de armazenamento por upload | Alta | O tamanho do arquivo não pode ultrapassar 100MB | 2 pts | Sprint 4 |
| FNF02 | Requisito Não Funcional | Plataforma Web | O sistema deve ser executado em navegadores web | Alta | O sistema deve rodar via web sem precisar de instalação local | 1 pt | Sprint 3 |

---

## 4. Histórias de Usuário
**02 - Tela de Envio de Material**
**História:** Como estudante com bons resumos, eu quero acessar uma tela de envio de arquivos simples e intuitiva, para que eu possa compartilhar meu material com os outros alunos.
...
**02 - Filtro por Ano/Semestre**
**História:** Como estudante, eu quero poder filtrar as atividades ou resumos antigos pelo ano ou semestre, para que eu possa focar em estudar o formato mais recente de cobrança dos professores.
**Critérios de aceitação:**
    - A tela de busca deve ter um filtro chamado "Ano/Semestre".

**03 - Acesso Institucional**
