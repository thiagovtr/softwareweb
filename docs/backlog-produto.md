...
## 4. Requisito técnico
**RT03 - Tela de Envio de Material**

**Descrição:**
Desenvolver a interface e o código simples para que o usuário consiga enviar o seu resumo ou prova antiga para a plataforma.
...
## 5. Observações
- O backlog técnico é dinâmico e pode mudar conforme o avanço do projeto e das aulas práticas.
- Novas necessidades estruturais serão adicionadas aqui caso o grupo identifique.